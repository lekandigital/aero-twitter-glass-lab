...
import { useExperimentSetOne } from '@/components/experiment-set-one/combinedSettings';
...
export function ExperimentFourLayerBSheet({ nested = false }: { nested?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <span
        className="experiment-four-layer-b__rim-side experiment-four-layer-b__rim-side--right"
        aria-hidden="true"
      />
