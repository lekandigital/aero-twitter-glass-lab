// @ts-nocheck — synced branch snapshot
/* Experiment 4 — E3 + opposite-corner highlights (CodePen PwzzovO) + reference left-panel sizing */

import type { CSSProperties } from 'react';
import type { MaterialFieldBase, MaterialSelectOption } from '@/components/shared/MaterialSettingControl';
import {
  ...
  type E2SheetSection,
} from '@/components/experiment-set-two/sheetMaterial';
import type { E3MaterialSettings } from '@/components/experiment-set-three/materialSettings';
import { buildInitialE3Settings } from '@/components/experiment-set-three/materialSettings';
import {
  buildFrostSurfaceProfileFields,
  frostSurfaceProfileCssVars,
  frostSurfaceProfileFieldIds,
  pickFrostSurfaceProfile,
} from '@/components/shared/frostSurfaceFinish';
