...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a {
  background:
    radial-gradient(
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a::before,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a::before {
  opacity: 0.34;
  box-shadow:
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a::after,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a::after {
  opacity: 0.035;
  background:
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a .glass-frost-matte,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a .glass-frost-matte {
  opacity: 0.34;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a .glass-frost-gloss,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a .glass-frost-gloss {
  opacity: 0.025;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim {
  background:
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-edge,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-edge {
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-edge--top,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-edge--top {
  opacity: 0.24;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-edge--bottom,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-edge--bottom {
  opacity: 0.1;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-side,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-side {
  background:
...
.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-side--left,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-side--left {
  opacity: 0.24;
  box-shadow: none;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__bezel-rim-side--right,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__bezel-rim-side--right {
  opacity: 0.14;
  box-shadow: none;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__radial-corners,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__radial-corners {
  opacity: 0.32;
  mix-blend-mode: screen;
}

.experiment-set-one-selected-save-stage[data-bezel-style="frosted-blue-matte"] .experiment-four-layer-a__pwzzovO-glass,
.experiment-set-one-page[data-e10-bezel-style="frosted-blue-matte"] .experiment-set-one-stage__multi-shell[data-stage-experiment="ten"] .experiment-four-layer-a__pwzzovO-glass {
