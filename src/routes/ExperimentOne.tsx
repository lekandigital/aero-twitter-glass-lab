    ...
    <ExperimentSetOneProvider>
      ...
      <header className="experiment-set-one-header">
        ...
        <p>
          ...
          pane as the right overlap pane. The dock's background row picks one of four stage backgrounds — default
          wallpaper, reference wallpaper, the local photo, or the local video.
        </p>
      </header>
